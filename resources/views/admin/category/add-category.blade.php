...
<head>
   ...
   <title>Online Baking Classes | course category</title>
...
<section class="form-container">
   ...
   @csrf
      ...
      <input type="text" name="name" placeholder="eg:masterclass cake" required maxlength="50" class="box">
      <p>Description <span>*</span></p>
      <textarea id="w3review" name="description" rows="4" cols="50" class="box"></textarea>
      <p>select thumb picture <span>*</span></p>
