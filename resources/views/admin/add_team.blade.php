...
<head>
  ...
  <title>MinatBakery - Add team</title>
  <!-- General CSS Files -->
  <!-- General CSS Files -->
    ...
    <div class="main-wrapper main-wrapper-1">
            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  @endif
                    <form method="POST" action="{{url('upload_team')}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                      <input type="text" class="form-control" name="insta_name">
                      </div>
                    </div>
                    <div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Facebook:</label>
                      <div class="col-sm-12 col-md-7">
                      <input type="text" class="form-control" name="face_name">
                      </div>
                    </div>
                    <div class="form-group row mb-4">
      ...
      <footer class="main-footer">
        <div class="footer-left">
          Copyright &copy; 2022 <div class="bullet"></div> Mind Garden <a href="#">Firm</a>
        </div>
